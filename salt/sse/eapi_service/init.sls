...
install_xmlsec:
  pkg.installed:
    - sources:
      - openssl: salt://{{ slspath }}/files/openssl-3.0.1-23.el9_0.x86_64.rpm
      - openssl-libs: salt://{{ slspath }}/files/openssl-libs-3.0.1-23.el9_0.x86_64.rpm
      ...
      - singleton-manager-i18n: salt://{{ slspath }}/files/singleton-manager-i18n-0.6.12-0.el7.x86_64.rpm
      - ssc-translation-bundle: salt://{{ slspath }}/files/ssc-translation-bundle-8.11.2-1.ph3.noarch.rpm

install_raas:
  pkg.installed:
    - sources:
      - raas: salt://{{ slspath }}/files/raas-8.11.2.6.el9.x86_64.rpm
...
import_initial_objects:
  cmd.run:
    - runas: raas
    - names:
      - "/usr/bin/raas dump --insecure --server {{ http_prefix }}localhost --auth {{ sse_eapi_username }}:{{ sse_eapi_password }} --mode import < /tmp/sample-resource-types.raas"
